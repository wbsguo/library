...
public class PullToRefreshSwipeListView extends PullToRefreshAdapterViewBase<SwipeMenuListView> {
	...
	public PullToRefreshSwipeListView(Context context, PullToRefreshBase.Mode mode, PullToRefreshBase.AnimationStyle style) {
	...
	protected class InternalListView extends SwipeMenuListView {
