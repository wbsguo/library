...
public class NoteDao extends AbstractDao<Note, Long> {
    ...
    public static final String descript = "DESCRIPT";//中途新增字段
    ...
    public static class Properties {
        ...
        public final static Property Kcal = new Property(5, String.class, "kcal", false, kcal);
        public final static Property Descript = new Property(6, String.class, "descript", false, descript);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Note entity) {
        ...
        double kcalValue = entity.getKcal();
        stmt.bindDouble(6,kcalValue);
        String descriptValue = entity.getDescript();
        if (descriptValue != null) {
            stmt.bindString(7, descriptValue);
        }
    }
    ...
    public Note readEntity(Cursor cursor, int offset) {
        Note entity = new Note(
                ...
                cursor.isNull(offset + 5) ? null : cursor.getDouble(offset + 5),
    ...
    public void readEntity(Cursor cursor, Note entity, int offset) {
        ...
        entity.setKcal(cursor.isNull(offset + 5) ? null : cursor.getDouble(offset + 5));
        entity.setDescript(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
    }
