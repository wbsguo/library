...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e("ssd","requestCode:"+requestCode+"resultCode:"+resultCode);
    }
